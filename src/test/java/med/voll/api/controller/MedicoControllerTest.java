...
class MedicoControllerTest {
    ...
    @WithMockUser
    void cadatrar_cenario2() throws Exception {
        ...
        var dadosDetalhento = new DadosDetalhamentoMedico(
                null,
                dadosCadastro.nome(),
                dadosCadastro.email(),
                dadosCadastro.crm(),
        ...
        var jsonEsperado = dadosDetalhamentoMedicoJacksonTester.write(dadosDetalhento).getJson();
